...
| 04:00–08:00 | 833.333 | 5947.420 |
| 08:00–12:00 | 3954.631 | 2121.418 |
| 12:00–16:00 | 6119.369 | 91.101 |
| 16:00–20:00 | 0.000 | 5068.687 |
| 20:00–24:00 | 8166.667 | 3571.313 |
| 0:00储电量 | 8550.000 | — |
| 24:00储电量 | 8550.000 | — |

图1显示购电主要转移至低价时段，光伏高发时段优先供负荷并为储能充电；图2显示SOC始终处于1200–10800 kWh运行区间且日末回到初始水平。自由$S_0$方案的费用为35118.599元；固定$S_0=6000$ kWh对照方案费用为35126.849元，差异为8.250000元，说明本例中初始SOC约束对最优费用的影响为该数值。
...
最大时段电量平衡残差为1.137e-13 kWh，最大SOC转移残差为1.137e-12 kWh；循环SOC残差为0.000e+00 kWh；Excel与CSV全天购电量残差为3.048e-08 kWh。六个分段充、放电汇总均覆盖24个时段且无遗漏，不存在同时充放电时段，充放电上限、SOC边界、购电费用和Excel写入均逐项复核通过。完整逐时计划见`outputs/question1/question1_full_schedule.csv`。
